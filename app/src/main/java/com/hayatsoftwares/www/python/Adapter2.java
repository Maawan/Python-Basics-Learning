...
public class Adapter2 extends RecyclerView.Adapter<Adapter.MyViewHolder> {
    ...
    private ArrayList<programModules> mList;
    private Context contxt;



    private int arraySize;
    public Adapter2(ArrayList<programModules> list , Context context){
        mList = list;
        contxt = context;
    }
    ...
    public Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        Adapter.MyViewHolder v = new Adapter.MyViewHolder(rootView);
        initiateFirebase();
        return v;
    }
    ...
    public void onBindViewHolder(@NonNull Adapter.MyViewHolder holder, final int position) {
        if(mList.get(position).getIdentifer().equals("error")   || mList.get(position).getIdentifer().equals("do") || mList.get(position).getIdentifer().equals("Programs")){
            ...
            if(mList.get(position).getIdentifer().equals("Programs")) {
                mList.get(position).setmDesc("Contains "+ sizeTemp +" Programs");
        ...
        holder.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                temp_bundle.putStringArray("questions",mList.get(position).getQuestions());
